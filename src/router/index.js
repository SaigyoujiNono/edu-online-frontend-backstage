...
export const constantRoutes = [
  ...
  },
  {
    ...
    name: '讲师管理',
    meta: { title: '讲师管理', icon: 'el-icon-s-check' },
    children: [
      // {
      //   path: 'table',
      //   name: '讲师列表',
      ...
      },
      {
        ...
        meta: { title: '添加讲师', icon: 'el-icon-plus' }
      }
    ]
  },
  {
    ...
    name: '课程分类',
    meta: { title: '课程分类', icon: 'el-icon-s-order' },
    children: [
      {
        path: 'tree',
        name: '分类列表',
      ...
      },
      {
        ...
        meta: { title: '添加分类', icon: 'el-icon-plus' }
      }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '添加课程',
        component: () => import('@/views/edu/course/Course'),
        meta: { title: '添加课程', icon: 'el-icon-plus', noCache: true },
        hidden: true
      }
    ]
  },
